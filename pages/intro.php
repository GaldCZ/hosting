...
<div class="w3-third">
  ...
  <h3>Your own VPS</h3><br>
  <i class="fa fa-desktop w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
  <p>Virtual private servers</p>
  <p>At all around world</p>
  <p>Free public IP</p>
  <p>Make your own rules</p>
  </div>
</div>

<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px">
  <h3>Your own UPC</h3><br>
  <i class="fa fa-wrench w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
  <p>User panel control</p>
  <p>Fast deployment</p>
  <p>Everything under your control</p>
...
<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px">
  <h3>Scalable</h3><br>
  <i class="fa fa-expand w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
  <p>Unlimited resources</p>
  <p>Pay as you go</p>
  <p>Turn off when you can</p>
  <p></p>
  </div>
</div>
</div>
...
<hr>
<div class="w3-center">
  <h2>Make first step</h2>

 <p>Verify your email, end enjoy our free trial.</p>
  <p>Our platform is builted on AWS.</p>
  <p>Let' start your path right now!!!</p>
